...
namespace AH.UI.ViewModels {
    public class ComputerViewModel : ViewModel {
        ...
        // View에 표시할 데이터를 ReactiveProperty로 정의 (Observer Pattern)
        ...
        public void SetUserName(string name) {
            ...
            // 상태 변경 후 메시지 갱신 (Observer Pattern)
            UpdateDisplay();
        }
        ...
        // DisplayMessage를 갱신하여 View에 알림 (Observer Pattern)

Shader "Universal Render Pipeline/Custom/Leaves"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                surfaceInput.albedo = albedoAlpha.rgb;
                surfaceInput.alpha = albedoAlpha.a;
                surfaceInput.specular = 0;
                surfaceInput.smoothness = 0;
                surfaceInput.occlusion = 1;
                
                // Apply lighting with Lambert model (similar to original shader)
